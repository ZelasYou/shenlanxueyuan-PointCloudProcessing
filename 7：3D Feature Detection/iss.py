...
def Point_Cloud_Show(point_cloud, feature_point):
    ...
    ax.scatter(point_cloud[:, 0], point_cloud[:, 1], point_cloud[:, 2], cmap='spectral', s=2, linewidths=0, alpha=1,
               marker=".")
...
if __name__ == '__main__':
    point_cloud = np.genfromtxt(r"E:\\PointCloudSourceFile\\txt\\modeled40_normal_resampled\\airplane\\airplane_0001.txt", delimiter=",")
